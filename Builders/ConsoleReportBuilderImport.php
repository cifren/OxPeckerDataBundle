...
class ConsoleReportBuilderImport extends ConsoleReportBuilder
{
    protected function configure()
    {
        $this
            ->setName('reportbuilder:import')
            ->setDescription('import a report')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $result = $builder->handleRequest('import', $params, $reportType, $connection);
